var OYSTERS = [
  ...
  },
  {
    ...
    name: "Blue Point NY",
    salinity: "medium",
    salinityText: "Medium–high — 30–32 ppt",
    region: "ny",
    origin: "Great South Bay, New York",
    farmer: "Blue Island Shellfish Farms",
    farmerUrl: "https://blueislandshellfish.com",
    species: "Crassostrea virginica (Eastern oyster)",
    farmingMethod: "Semi-wild harvested / farmed",
    growOut: "18–36 months",
    seasonalAvailability: "Year-round",
    size: "Medium — 2.5–3.5\"",
    shell: "Gray with bluish hue; moderate cup",
    tastingNotes: "Fresh, crisp, firm bite with moderately high brine and briny punch; clean mineral quality.",
  ...
  {
    id: "carolina-dreams",
    name: "Carolina Dreams",
    salinity: "medium",
    salinityText: "Medium–high — 20–26 ppt",
    region: "nc",
    origin: "Stump Sound, North Carolina",
    farmer: "Falling Tide Oyster Co.",
    farmerUrl: "https://www.instagram.com/fallingtideoysterco/",
    species: "Crassostrea virginica (Eastern oyster)",
    farmingMethod: "Floating cage culture",
    growOut: "18–24 months",
    seasonalAvailability: "Year-round",
    size: "Medium — 2.5–3.5\"",
    shell: "Deep-cupped from active growing environment",
    tastingNotes: "Balanced brine with subtle sweetness; clean, briny finish.",
    notable: "Produced by Falling Tide Oyster Co., operated by Keith Walls, a marine scientist with 20+ years in food service. NOT the same oyster as Carolina Envy despite naming similarity.",
    photoUrl: null,
    photoAlt: "Carolina Dreams oysters on the half shell",
    price: 4
  },
  {
    id: "madhouse",
    name: "Madhouse",
    salinity: "medium",
    salinityText: "Medium — 18–24 ppt",
    region: "md",
    origin: "Hoopers Island, Chesapeake Bay, Maryland",
    farmer: "Madhouse Oyster Farm",
    farmerUrl: "http://madhouseoysters.com/our-oysters/",
    species: "Crassostrea virginica (Eastern oyster)",
    farmingMethod: "Bay cage culture with hatchery-raised seed",
    growOut: "18–24 months",
    seasonalAvailability: "Year-round",
    size: "Medium — 2.5–3.5\"",
    shell: "Moderate cup; variable shape from natural growth",
    tastingNotes: "Balanced brine and sweetness; crisp, clean finish with subtle briny undertone.",
    notable: "Located on Hoopers Island's barrier-island chain in Maryland's Chesapeake Bay. Uses upweller hatchery systems for larval rearing before deployment to bay cages.",
    photoUrl: null,
    photoAlt: "Madhouse oysters on the half shell",
    price: 4
  },
  {
    ...
    salinity: "low",
    salinityText: "Low–medium — 10–18 ppt",
    region: "pei",
    origin: "Stanhope, Prince Edward Island, Canada",
    farmer: "Murphy Oyster Company",
    farmerUrl: "https://www.murphyoystercompany.com/",
    species: "Crassostrea virginica (Eastern oyster)",
    farmingMethod: "Suspension culture (trays and cages)",
    growOut: "24–30 months",
    seasonalAvailability: "Year-round",
    size: "Small–medium — 2.5–3\"",
  ...
  },
  {
    ...
    region: "ma",
    origin: "Cape Cod, Massachusetts",
    farmer: "Sunken Meadow Oyster Farm",
    farmerUrl: null,
    species: "Crassostrea virginica (Eastern oyster)",
    farmingMethod: "Cage culture in sandy bottom cove",
    growOut: "18–24 months",
    seasonalAvailability: "Year-round",
    size: "Medium — 2.5–3\"",
    shell: "Clean appearance from sandy bottom environment",
    tastingNotes: "Plump meats, briny liquor, clean and refreshing finish.",
    notable: "Located on the bay side of Cape Cod, south of Wellfleet Harbor. Sandy bottom and strong tidal exchange create characteristic brine and texture.",
    photoUrl: null,
    photoAlt: "Sunken Meadow oysters on the half shell",
    price: 4
  },
  {
    id: "sweet-jesus",
    name: "Sweet Jesus",
    salinity: "low",
    salinityText: "Low–medium — 12–18 ppt",
    region: "md",
    origin: "Patuxent River, Chesapeake Bay, Maryland",
    farmer: "Hollywood Oyster Company",
    farmerUrl: "https://www.hollywoodoyster.com/",
    species: "Crassostrea virginica (Eastern oyster)",
    farmingMethod: "Cage and tray culture with tumbling; hatchery-raised seed",
    growOut: "~20 months",
    seasonalAvailability: "Year-round",
    size: "Medium — 3\"",
  ...
  },
  {
    ...
    name: "Va Va Voom",
    salinity: "medium",
    salinityText: "Medium — 16–22 ppt",
    region: "md",
    origin: "Patuxent River, Chesapeake Bay, Maryland",
    farmer: "Hollywood Oyster Company",
    farmerUrl: "https://www.hollywoodoyster.com/the-oysters/va-va-voom/",
    species: "Crassostrea virginica (Eastern oyster)",
    farmingMethod: "Cage culture in shallow sandy bottom cove with regular tumbling",
    growOut: "18–24 months",
    seasonalAvailability: "Year-round",
    size: "Medium — 3\"",
    shell: "Deep cup from regular tumbling; clean appearance from sandy bottom",
    tastingNotes: "Medium brine with soft mossy, almost floral hints; clean, crisp finish.",
